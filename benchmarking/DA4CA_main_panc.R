...
dir.create(res_dir)
annot = read.table(file = '/Users/rao198/OneDrive\ -\ Harvard\ University/Informatics/Analysis/DA4LT/pancreas/04_mergeTwoDatasets/reactome.db_mouse_human_norm_var_GSEAS_pvalue_FALSE_0.05_0.07_common_Merged_annot.txt', header=T, sep="\t", row.names = 1)
print(dim(annot))
if(! 'type' %in% names(annot))
  annot$type = annot$cell.names
...
merged_score12 = read.table(file = '/Users/rao198/OneDrive\ -\ Harvard\ University/Informatics/Analysis/DA4LT/pancreas/04_mergeTwoDatasets/reactome.db_mouse_human_norm_var_GSEAS_pvalue_FALSE_0.05_0.07_common_Merged.txt', header=T, sep="\t", row.names = 1)
