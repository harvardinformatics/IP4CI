...
#' @examples
#' calcSim_avgCT(df, annot, id.list,res_dir)
#' @export
###############################################################################
calcSim_avgCT <- function(df, annot, id.list,ct,res_dir)
{
  ...
  print(corrplot(as.matrix(dist_sim), type = "full",is.corr = FALSE, tl.col="black",
  ...
  print(corrplot(as.matrix(dist_sim1), type = "full",is.corr = FALSE, tl.col="black",
                 insig = "blank",cl.ratio = .2, cl.align = "c",tl.cex = 1.2,col=brewer.pal(n=8, name="RdBu"),
                 cl.cex = 1/par("cex"),tl.srt = 90,
                 title=paste0(dist_name,'\n',id1) ,mar=c(0,0,1,0))) #, method="number"

  print(corrplot(as.matrix(dist_sim2), type = "full",is.corr = FALSE, tl.col="black",
                 insig = "blank",cl.ratio = .2, cl.align = "c",tl.cex = 1.2,col=brewer.pal(n=8, name="RdBu"),
                 cl.cex = 1/par("cex"),tl.srt = 90,
                 title=paste0(dist_name,'\n',id2) ,mar=c(0,0,1,0)))

  # norm sim
  print(corrplot(as.matrix(dist_sim_norm), type = "full",is.corr = FALSE, tl.col="black",
                 insig = "blank",cl.ratio = .2, cl.align = "c",tl.cex = 1.2,col=brewer.pal(n=8, name="Blues"),
                 method = 'color',
                 cl.cex = 1/par("cex"),tl.srt = 90,
                 title=paste0(dist_name,'\n',paste0(id2,'&',id1)) ,mar=c(0,0,1,0))) #, method="number"

  print(corrplot(as.matrix(dist_sim1_norm), type = "full",is.corr = FALSE, tl.col="black",
                 insig = "blank",cl.ratio = .2, cl.align = "c",tl.cex = 1.2,col=brewer.pal(n=8, name="Blues"),
                 method = 'color',
                 cl.cex = 1/par("cex"),tl.srt = 90,
                 title=paste0(dist_name,'\n',id1) ,mar=c(0,0,1,0))) #, method="number"

  print(corrplot(as.matrix(dist_sim2_norm), type = "full",is.corr = FALSE, tl.col="black",
                 insig = "blank",cl.ratio = .2, cl.align = "c",tl.cex = 1.2,col=brewer.pal(n=8, name="Blues"),
