...
# saveRDS(integrated_res,paste0(res_dir,'merged_integrated.RDS') )
# integrated_res = readRDS(paste0(res_dir,'merged_integrated.RDS'))
...
# run_06_similarityCalculation(integrated_res,integrated_res$meta.data,id.list=c(id1,id2),ct='all',res_dir)
# run_06_similarityCalculationIntegration(integrated_res,integrated_res$meta.data,id.list=c(id1,id2),ct='all',res_dir)
#```
################################################################################
...
# CTs = c('macrophage')#unique(annot$type)
# for(ct in CTs)
# {
#   print(ct)
#   # get samples
...
# saveRDS(cc_res_ct,paste0(res_dir,ct,'merged_cca.RDS') )
